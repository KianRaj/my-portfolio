...
popup.className = 'fixed inset-0 flex items-center justify-center z-50 bg-black/80';
popup.innerHTML = `
...
<span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500">About Me</span>
<div className="h-1 w-20 bg-gradient-to-r from-purple-600 to-blue-500 mt-2"></div>
</h2>
<p className="text-gray-300 mb-6 leading-relaxed">
I'm currently pursuing my M.Tech in Computer Science at IIIT Delhi, specializing in Computer Science and Engineering. My research focuses on advanced AI applications, particularly in the field of Generative AI and intelligent systems.
</p>
<p className="text-gray-300 mb-6 leading-relaxed">
As a Research Assistant at MIDAS Lab, I'm working on Real-time Accident Detection and Prediction using Depth Estimation as my thesis work. I also serve  as  Research Intern in UIUC+ Summer Program Under the Darko Marinov, where we need to label equivalent mutant from their repository where we need to give 20 hours per week Remotely.
</p>
</div>
<div className="md:w-1/2">
...
{["Generative AI", "ML","DL","LLM","OOPS","Pytorch", "Agentic RAG", "CrewAI", "OpenCV", "Computer Vision","RAG"].map((skill, index) => (
<span
key={index}
...
<span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500">Education & Research</span>
...
<h4 className="text-xl font-bold text-purple-400 mb-2">M.Tech in Computer Science and Engineering</h4>
<h5 className="text-lg text-gray-300 mb-4">IIIT Delhi</h5>
<p className="text-gray-400 mb-4">
Specializing in Computer Science and Engineering with a focus on AI and intelligent systems.
</p>
<div className="flex flex-wrap gap-2">
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Computer Science</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Artificial Intelligence</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Machine Learning</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Deep Learning</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Large Language Model</span>
</div>
</div>
</div>
</div>
...
<div className="md:w-3/4">
<h4 className="text-xl font-bold text-purple-400 mb-2">Research Assistant</h4>
<h5 className="text-lg text-gray-300 mb-4">MIDAS Lab - IIIT Delhi</h5>
<p className="text-gray-400 mb-4">
Working on Real-time Accident Detection and Prediction using Depth Estimation as a thesis work.
</p>
<p className="text-gray-400 mb-4">
The research focuses on developing AI models that can detect and predict accidents in real-time using advanced depth estimation techniques.
</p>
</div>
</div>
</div>
...
<div className="md:w-3/4">
<h4 className="text-xl font-bold text-purple-400 mb-2">Teaching Assistant</h4>
<h5 className="text-lg text-gray-300 mb-4">IIIT Delhi</h5>
<p className="text-gray-400 mb-4">
Serving as a Teaching Assistant for Data Structures and Algorithms (DSA) and Introduction to Programming in Python courses during the first and second semesters.
</p>
<p className="text-gray-400 mb-4">
Responsibilities include conducting Tut, lab sessions, grading assignments, and providing one-on-one assistance to students.
</p>
</div>
</div>
</div>
...
<div className="md:w-3/4">
<h4 className="text-xl font-bold text-purple-400 mb-2">Research Intern</h4>
<h5 className="text-lg text-gray-300 mb-4">UIUC+ Summer Research Program</h5>
<p className="text-gray-400 mb-4">
Labelling mutant equivalent mutant on UIUC Plus project repository and generating tests using LLMs to evaluate their efficiency.
</p>
<p className="text-gray-400 mb-4">
The research aims to assess the effectiveness of LLM-generated tests in identifying software mutants.
</p>
</div>
</div>
</div>
...
<div className="container mx-auto px-6">
<h2 className="text-3xl font-bold mb-12 text-center relative">
<span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500">Projects</span>
<div className="h-1 w-20 bg-gradient-to-r from-purple-600 to-blue-500 mt-2 mx-auto"></div>
</h2>
...
<div className="p-6">
<h3 className="text-xl font-bold text-purple-400 mb-2">Image to Text Generation</h3>
<p className="text-gray-400 mb-4">
Developed a system for generating textual descriptions from flower images using Conditional Generative Adversarial Networks (CGAN).
</p>
<div className="flex flex-wrap gap-2 mb-4">
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">CGAN</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Deep Learning</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Computer Vision</span>
</div>
...
<div className="p-6">
<h3 className="text-xl font-bold text-purple-400 mb-2">Video Compression</h3>
<p className="text-gray-400 mb-4">
Implemented an unsupervised learning approach using K-means clustering for efficient video compression.
</p>
<div className="flex flex-wrap gap-2 mb-4">
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">K-means</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Unsupervised Learning</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Compression</span>
</div>
<button className="!rounded-button whitespace-nowrap mt-2 px-4 py-2 bg-transparent border border-purple-500 text-purple-400 text-sm cursor-pointer hover:bg-purple-500/10 transition-all">
View Details
</button>
...
<div className="p-6">
<h3 className="text-xl font-bold text-purple-400 mb-2">Sound Generation from ECG</h3>
<p className="text-gray-400 mb-4">
Created a system that generates sound patterns from ECG datasets, enabling auditory analysis of heart rhythms.
</p>
<div className="flex flex-wrap gap-2 mb-4">
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Signal Processing</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Audio Synthesis</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Healthcare</span>
</div>
<button className="!rounded-button whitespace-nowrap mt-2 px-4 py-2 bg-transparent border border-purple-500 text-purple-400 text-sm cursor-pointer hover:bg-purple-500/10 transition-all">
View Details
</button>
...
<div className="p-6">
<h3 className="text-xl font-bold text-purple-400 mb-2">Customer Outreach Campaign</h3>
<p className="text-gray-400 mb-4">
Developed an LLM-powered system for personalized customer outreach, improving engagement and conversion rates.
</p>
<div className="flex flex-wrap gap-2 mb-4">
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">LLM</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">NLP</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Marketing</span>
</div>
<button className="!rounded-button whitespace-nowrap mt-2 px-4 py-2 bg-transparent border border-purple-500 text-purple-400 text-sm cursor-pointer hover:bg-purple-500/10 transition-all">
View Details
</button>
...
<div className="p-6">
<h3 className="text-xl font-bold text-purple-400 mb-2">Multi-agent Book Recommendation</h3>
<p className="text-gray-400 mb-4">
Created a multi-agent system for personalized book recommendations with Langfuse evaluation metrics.
</p>
<div className="flex flex-wrap gap-2 mb-4">
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Multi-agent</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Langfuse</span>
<span className="!rounded-button whitespace-nowrap px-3 py-1 bg-gray-800 text-xs text-gray-300">Recommendation</span>
</div>
<button className="!rounded-button whitespace-nowrap mt-2 px-4 py-2 bg-transparent border border-purple-500 text-purple-400 text-sm cursor-pointer hover:bg-purple-500/10 transition-all">
View Details
</button>
...
<div className="container mx-auto px-6">
<h2 className="text-3xl font-bold mb-12 text-center relative">
<span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500">Get In Touch</span>
<div className="h-1 w-20 bg-gradient-to-r from-purple-600 to-blue-500 mt-2 mx-auto"></div>
</h2>
...
<h3 className="text-xl font-semibold text-purple-400 mt-8 mb-6">Connect</h3>
...
<div className="md:w-1/2">
<h3 className="text-xl font-semibold text-purple-400 mb-6">Send a Message</h3>
